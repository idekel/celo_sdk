...
void main() {
  test('signs transactions', () async {
    ...
    expect(bytesToHex(signature),
        'f86080010a80808094c914bb2ba888e3367bceceb5c2d99df7c74237060a8025a04ae1493be9763b79c9d432525d04d1ed73f72fcb12b05ac069e36df91d3b6620a07206146fef7bc88ca00d37d9204f44f589d143fcd8f5664cb8a84a41385bcef0');
  });
  ...
  test('signs eip 155 transaction', () async {
    ...
    expect(
        ...
        'f86f098504a817c80082520880808094353535353535353535353535353535353'
        '5353535880de0b6b3a76400008025a022f12ae0c33759d4fa82c145de69ec907850ced'
        'e6722a3bf3b7b69d78a5b0a1ba02d12f090c4d8c636677e0cb3619938294001b528b49b'
        '9ea16d32502227e8f5ee');
  });
}
